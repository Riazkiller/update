...
RH = """
\x1b[31;1m   __This Tool Create by RIAZKHAN
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
	    ...
	    time.sleep(2)
            ...
            print " Tkaya Bba andam la Staff riazkhan Ta ID w Pass Dast Kawet"
    else:
        print "\033[1;96mIDya Kat Halaya "
        print "Tkaya Bba andam la Staff ruazkhan Ta ID w Pass Dast Kawet"
